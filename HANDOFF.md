...
> **最終更新**: 2026-02-13
> **最終更新者**: Claude Code
> **最終コミット**: `docs: 通常月CSV突合完了（2025-11/12支給 全項目MF一致）`
> **ステータス**: 通常月突合完了。残課題は伊達良幸の正式データ設定のみ。
...
- 現在ブランチ: `main`
- 最新コミット: `docs: 通常月CSV突合完了（2025-11/12支給 全項目MF一致）`
- 次に着手する課題: 伊達良幸の正式データ設定（ユーザーから基本給・標準報酬・保険フラグ共有待ち）
- プレビューURL: `http://127.0.0.1:3000`
- 検証結果: 2025-11/12支給（通常月）全3名・全項目MF完全一致を確認。2026-01は例外月のため対象外。
