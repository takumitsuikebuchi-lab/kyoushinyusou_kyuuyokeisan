...
> **最終更新**: 2026-02-13
> **最終更新者**: Codex
> **最終コミット**: `docs: 1月例外条件と通常月CSV突合の前提を追記`
> **ステータス**: 2026-01は例外月（渡会/門馬）として通常突合から除外。次は2025-10勤務分/2025-11勤務分CSVで通常月突合を実施。
...
- 現在ブランチ: `main`
- 最新コミット: `docs: 1月例外条件と通常月CSV突合の前提を追記`
- 次に着手する課題: `通常月のMF元CSV突合`（2025-10勤務分→2025-11支給、2025-11勤務分→2025-12支給）
- プレビューURL: `http://127.0.0.1:3000`
- 検証結果: 2025-11/12支給CSV受領済み（Downloads）。1月分は例外月のため通常突合対象外と合意済み
...
| 優先度 | 項目 | 詳細 |
|--------|------|------|
| **高** | 通常月のMF元CSV突合（2025-10/2025-11勤務分） | ユーザー提供CSV: `確定結果_2025年11月20日支給 (1).csv`（10月勤務分）、`確定結果_2025年12月20日支給 (1).csv`（11月勤務分） |
